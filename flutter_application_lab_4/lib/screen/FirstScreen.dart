...
import 'package:flutter_application_lab_4/screen/cubit/main_screen_cubit_provider.dart';
...
class _FirstScreenState extends State<FirstScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Лабораторная работа №3 Богушевич Д.А. ВМК-22 вар(2)')),
      body: Padding(
        ...
        child: Form(
          ...
          child: Column(
            children: [
              ...
              CheckboxListTile(
                value: _agreement,
                title: const Text('Согласны ли вы на использование калькулятора квадратных чисел, при его использвание вы продаете себя в рабство разработчика, до сих пор желаете?', style: TextStyle(fontSize: 10.0)),

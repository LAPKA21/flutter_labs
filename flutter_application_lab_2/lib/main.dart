...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          title: Text('Лабораторная работа №2 Богушевич Д.А. ВМК-22 вар(2)'),
        ),
        body: MyHomePage(),
      ),
    );
        ...
        children: <Widget>[ 
          Column(
            children: [
              ...
              child: Text('Фио: Богушевич Данил Александрович', style: TextStyle(fontSize: 30, color: Color.fromRGBO(3, 252, 198, 1.0) ))),
              Padding(padding: EdgeInsets.all(16.0),
              child: Text('Группа  обучения: ВМК-22 ', style: TextStyle(fontSize: 25,color: Color.fromRGBO(3, 252, 45, 1.0)),)),
              Padding(padding: EdgeInsets.all(16.0),

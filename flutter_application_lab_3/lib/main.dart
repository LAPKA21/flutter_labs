...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          title: Text('Лабораторная работа №3 Богушевич Д.А. ВМК-22 вар(2)'),
        ),
        body: MyHomePage(),
      ),
    );
...
Widget build(BuildContext  context){
  return Container(
    ...
    child: Form(
      ...
      CheckboxListTile(value: _agreement, title: Text('Согласны ли вы на использование калькулятора квадратных чисел, при его использвание вы продаете себя в рабство разработчика, до сих пор желаете?', style: TextStyle(fontSize: 10.0),)
